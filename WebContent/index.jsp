...
<html>
    ...
    <body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-md-7 py-4">
                            ...
                            <p class="text-muted">�crire un truc de ouf guedin</p>
                        </div>
      ...
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <p class="lead text-muted">Une solution originale et innovante, AXA vous propose une nouvelle mani�re de vous assurer !</p>
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Entrez votre pr�nom">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Ville</label>
    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Entrez votre ville">
  </div>
    <small id="emailHelp" class="form-text text-muted">Ces informations resteront confidentielles (oupa je s�pa)</small>
	<input type="hidden" name="action" value="souscription"/>
  <button type="submit" class="btn btn-primary">Souscrire � un smart contrat</button>
</form>
        ...
        <footer class="text-muted">
            <div class="container">
                ...
                <p>Projet r�alis� dans la cadre d'un workshop pour l'EPSI Montpellier - Novembre 2018</p>
            </div>
        </footer>
